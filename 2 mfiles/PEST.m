...
% original PEST procedure by Taylor and Creelman (1967).
%
%
% bibliography:
%
...
%           Double):  basierend auf dem Adaptionsmechansimus des PEST-
%                     Verfahrens nach Taylor und Creelman (1967).(Nach dem 
%                     letzten Funktionsaufruf ist dieser Wert gleich der 
%                     Schätzung der Schwelle in x_est.)
...
%
%   W (Double)  : Deviation-Limit für Signifikanz-Test
%
% -------------------------------------------------------------------------
%
...
function [x_next, x_est] = PEST(x_hist, r_hist, range, dx_ini, dx_max, P_t, W)
