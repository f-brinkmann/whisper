function varargout = abchr_mushra_gui_settings(varargin)
% ABCHR_MUSHRA_GUI_SETTINGS MATLAB code for abchr_mushra_gui_settings.fig
%      ABCHR_MUSHRA_GUI_SETTINGS, by itself, creates a new ABCHR_MUSHRA_GUI_SETTINGS or raises the existing
%      singleton*.
%
%      H = ABCHR_MUSHRA_GUI_SETTINGS returns the handle to a new ABCHR_MUSHRA_GUI_SETTINGS or the handle to
%      the existing singleton*.
%
%      ABCHR_MUSHRA_GUI_SETTINGS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ABCHR_MUSHRA_GUI_SETTINGS.M with the given input arguments.
%
%      ABCHR_MUSHRA_GUI_SETTINGS('Property','Value',...) creates a new ABCHR_MUSHRA_GUI_SETTINGS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before abchr_mushra_gui_settings_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to abchr_mushra_gui_settings_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help abchr_mushra_gui_settings

% Last Modified by GUIDE v2.5 31-Mar-2015 15:14:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @abchr_mushra_gui_settings_OpeningFcn, ...
                   'gui_OutputFcn',  @abchr_mushra_gui_settings_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before abchr_mushra_gui_settings is made visible.
function abchr_mushra_gui_settings_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to abchr_mushra_gui_settings (see VARARGIN)

% Choose default command line output for abchr_mushra_gui_settings
...
function varargout = abchr_mushra_gui_settings_OutputFcn(hObject, eventdata, handles) 
...
geo.sli_range_off = str2double(get(handles.ed_5, 'string'));
